...
struct Options opt = { 
	42,      /* swarm size */ 
	0.9,     /* cognitial parameter */
	0.9,     /* social parameter */
	0.5,     /* maximum velocity factor */
	5000,    /* maximum of iterations */
	5000,    /* maximum of function evaluations */
	0.9,     /* initial weight */
	0.4,     /* final weight */
...
int PSwarm(int n, void (*objf)(), double *lb, double *ub, int lincons, double *A,
		   double *b, double **sol, double *f, double *x)
{
	int i,j, iter, gbest, success, actives, iterunsuc=0, process;
	double *maxv, maxnormv, normtmp, weight, mindelta, normtmp2,*z;
